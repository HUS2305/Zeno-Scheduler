...
export default function TeamManagementClient({ 
  ...
  const handleInviteSubmit = async (e: React.FormEvent) => {
    ...
    console.log('Submitting invitation:', { ...inviteForm, businessId: business.id });
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(`Error: ${responseData.error || 'Failed to send invitation'}`);
      }
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <div className="text-2xl font-bold text-gray-900">{business.teamInvitations.length}</div>
