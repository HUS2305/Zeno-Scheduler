...
export default function AppointmentModal({
  ...
  useEffect(() => {
    if (isOpen) {
      fetchServices();
      fetchCustomers();
      // Reset date and time to the selected slot
  ...
  }, [isOpen, selectedDate, selectedTime, preSelectedCustomer]);
  ...
  const handleCreateAppointment = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log("Dispatching appointment-changed event from AppointmentModal");
